...
public class MainForm extends javax.swing.JFrame {
    ...
    private String mydownloadfolder = "E:\\";
    ...
    public void connect(){
        appendMessage(" Đang kết nối...", "Trạng thái", textColor, textColor);
        try {
            socket = new Socket(host, port);
            dos = new DataOutputStream(socket.getOutputStream());
            // gửi username đang kết nối
            dos.writeUTF("CMD_JOIN "+ username);
            appendMessage(" Kết nối thành công", "Trạng thái", textColor, textColor);
    ...
    */
    public void openFolder(){
        ...
        if(open == JFileChooser.APPROVE_OPTION){  // open == chooser.APPROVE_OPTION
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Giải mã");

        jMenuItem1.setText("Giải mã AES");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        DecryptForm dM = new DecryptForm();
        dM.setVisible(true);
